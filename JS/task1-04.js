...
// const userOrder = prompt("Введите необходимое количество товара:");
// let orderCost = userOrder * pricePerDroid;
// let creditBalance = credit - orderCost;
// if (orderCost > credit) {
//   message = "Недостаточно средств на счету!";
// } else if (userOrder === null) {
//   message = "Отменено пользователем!";
// } else if (orderCost <= credit) {
//   message = `'Вы купили ${userOrder} дроидов, на счету осталось ${creditBalance} кредитов.'`;
// }
